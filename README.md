...
ここまでで、スクラッチの画面サイズに対して、ボクセラミングのスプライトサイズが8分の1になるように設定されている。

次は、ボクセラミングのスプライトサイズの計算を行う。

- ボクセラミングの画面サイズは、480x360になる。
- スプライトのボクセルサイズは、360 / 8 / 8 = 5.625になる。
- したがって、スプライトの画像サイズは、128 / 5.625 = 22.755555555555556になる。
- したがって、送信するスプライトのサイズは、5.626 / 35 = 0.16074285714285715の係数を掛ければ良い
